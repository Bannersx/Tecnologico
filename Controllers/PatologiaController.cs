...
namespace HospitalTECnologico.Controllers
{
    public class PatologiaController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            List<HospitalTECnologico.Models.Patologia> patologias = new List<HospitalTECnologico.Models.Patologia>(dt.Rows.Count);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow patologiaRecord in dt.Rows)
                {
                    patologias.Add(new readPatologia(patologiaRecord));
                }
            }
        ...
        public HttpResponseMessage Get(int id)
        {
            ...
            conn.Open();
            // quite complex sql statement
            string sql = "SELECT * FROM patologia WHERE idpatologia =" + id;
            // data adapter making request from our connection
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            // i always reset DataSet before i do
            // something with it.... i don't know why :-)
        ...
        // POST: api/Test
        public HttpResponseMessage Post([FromBody] createPatologia value)
        {
            ...
            var query = "INSERT INTO public.patologia (nombre, descripcion) values(@nombre, @descripcion)";
            ...
            insertCommand.Parameters.AddWithValue("@descripcion", value.Descripcion);
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            //Query String
            var query = "DELETE FROM public.patologia WHERE idpatologia=" + id;
