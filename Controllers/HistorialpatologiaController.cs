...
{
    public class HistorialPatologiaController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            string sql = "SELECT * FROM HistorialPatologia";
            ...
            List<HospitalTECnologico.Models.HistorialPatologia> patologias = new List<HospitalTECnologico.Models.HistorialPatologia>(dt.Rows.Count);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow patologiaRecord in dt.Rows)
                {
                    patologias.Add(new readHistorialPatologia(patologiaRecord));
                }
            }
        ...
        // GET: api/Test/5
        [Route("api/HistorialPatologia/{id:int}")]
        [HttpGet]
        public HttpResponseMessage Get(int id)
        {
            ...
            conn.Open();
            // quite complex sql statement
            string sql = "SELECT * FROM HistorialPatologia WHERE idHistorialPatologia =" + id;
            // data adapter making request from our connection
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            // i always reset DataSet before i do
            // something with it.... i don't know why :-)
        ...
        // POST: api/Test
        public HttpResponseMessage Post([FromBody] createHistorialPatologia value)
        {
            ...
            var query = "INSERT INTO public.HistorialPatologia (idpaciente, idpatologia, fecha) values(@idpaciente, @idpatologia, @fecha)";
            ...
            insertCommand.Parameters.AddWithValue("@idpaciente", value.Paciente);
            insertCommand.Parameters.AddWithValue("@idpatologia", value.Patologia);
            insertCommand.Parameters.AddWithValue("@fecha", value.Fecha);
            connstring.Open();
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            //Query String
            var query = "DELETE FROM public.HistorialPatologia WHERE idHistorialPatologia=" + id;
