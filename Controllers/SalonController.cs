...
namespace HospitalTECnologico.Controllers
{
    public class SalonController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            List<HospitalTECnologico.Models.Salon> patologias = new List<HospitalTECnologico.Models.Salon>(dt.Rows.Count);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow patologiaRecord in dt.Rows)
                {
                    patologias.Add(new readSalon(patologiaRecord));
                }
            }
        ...
        // POST: api/Test
        public HttpResponseMessage Post([FromBody] createSalon value)
        {
            ...
            var query = "INSERT INTO public.salon (nombre, capacidad, tipo, piso) values( @nombre, @capacidad, @tipo, @piso)";
            ...
            insertCommand.Parameters.AddWithValue("@capacidad", value.Capacidad);
            insertCommand.Parameters.AddWithValue("@tipo", value.Tipo);
            insertCommand.Parameters.AddWithValue("@piso", value.Piso);
            connstring.Open();
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            //Query String
            var query = "DELETE FROM public.salon WHERE idsalon=" + id;
