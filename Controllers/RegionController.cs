...
namespace HospitalTECnologico.Controllers
{
    public class RegionController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            List<HospitalTECnologico.Models.Region> patologias = new List<HospitalTECnologico.Models.Region>(dt.Rows.Count);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow patologiaRecord in dt.Rows)
                {
                    patologias.Add(new readRegion(patologiaRecord));
                }
            }
        ...
        // POST: api/Test
        public HttpResponseMessage Post([FromBody] createRegion value)
        {
            ...
            var query = "INSERT INTO public.region (nombre, idpais) values(@nombre, @idpais)";
            ...
            insertCommand.Parameters.AddWithValue("@idpais", value.Pais);
            connstring.Open();
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            //Query String
            var query = "DELETE FROM public.region WHERE idregion=" + id;
