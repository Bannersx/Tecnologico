...
{
    public class CamaequipomedicoController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            string sql = "SELECT * FROM CamaEquipomedico";
            ...
            List<HospitalTECnologico.Models.CamaEquipomedico> patologias = new List<HospitalTECnologico.Models.CamaEquipomedico>(dt.Rows.Count);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow patologiaRecord in dt.Rows)
                {
                    patologias.Add(new readCamaEquipomedico(patologiaRecord));
                }
            }
        ...
        // GET: api/Test/5
        [Route("api/CamaEquipomedico/{id:int}")]
        [HttpGet]
        public HttpResponseMessage Get(int id)
        {
            ...
            conn.Open();
            // quite complex sql statement
            string sql = "SELECT * FROM CamaEquipomedico WHERE idcamaequipomedico =" + id;
            // data adapter making request from our connection
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            // i always reset DataSet before i do
            // something with it.... i don't know why :-)
        ...
        // POST: api/Test
        public HttpResponseMessage Post([FromBody] createCamaEquipomedico value)
        {
            ...
            var query = "INSERT INTO public.CamaEquipomedico (idcama, idequipomedico) values(@idcama, @idequipomedico)";
            ...
            insertCommand.Parameters.AddWithValue("@idcama", value.IdCama);
        ...
        public HttpResponseMessage Delete(int id)
        {
            ...
            //Query String
            var query = "DELETE FROM public.CamaEquipomedico WHERE idcamaequipomedico=" + id;
